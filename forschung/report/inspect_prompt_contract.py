...
def main() -> None:
    ...
    report = {
        ...
        "streaming_plain_generate_line": line_number(generation_source, "self.generation.generate(messages, config=gen_config)"),
        "streaming_path_uses_plain_generate": "self.generation.generate(messages, config=gen_config)" in stream_source,
